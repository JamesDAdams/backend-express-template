...
export class NotificationWorker {
    ...
    constructor() {
        ...
        const redisPort = process.env['WORKER_REDIS_PORT'] ? parseInt(process.env['WORKER_REDIS_PORT']) : 6379;
        const connection = { host: redisUrl, port: redisPort };

        this.notificationWorker = new Worker('notification', async (job: Job) => {
        ...
        this.notificationQueue = new Queue('notification', { connection: connection });
